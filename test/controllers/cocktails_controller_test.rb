...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post cocktails_url, params: { cocktail: { image: @cocktail.image, ingredients: @cocktail.ingredients, instructions: @cocktail.instructions, name: @cocktail.name } }, as: :json
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { image: @cocktail.image, ingredients: @cocktail.ingredients, instructions: @cocktail.instructions, name: @cocktail.name } }, as: :json
    assert_response 200
  end
